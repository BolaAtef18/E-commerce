...
public class addDifferentProductsToCompareListStepDef {
    ...
    public void add_different_products_to_compare_list() throws InterruptedException {
        Thread.sleep(5000);
        comparelistPage.comparelist1POM(driver).click();
        Thread.sleep(5000);
        WebElement AddToCart1 = comparelistPage.comparelist2POM(driver);
        new Actions(driver).clickAndHold(AddToCart1).perform();
        comparelistPage.comparelist3POM(driver).click();
        Thread.sleep(5000);
        WebElement AddToCart2 = comparelistPage.comparelist4POM(driver);
        new Actions(driver).clickAndHold(AddToCart2).perform();
        comparelistPage.comparelist5POM(driver).click();
        Thread.sleep(5000);
    }
